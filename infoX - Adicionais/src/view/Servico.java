	...
	public Servico() {
		...
		chkOrcamento.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				tipo = "Orçamento";
				if (chkOrcamento.isSelected()) {
					cboStatus.setModel(new DefaultComboBoxModel(new String[] {"Aguardando aprova\u00E7\u00E3o"}));
				}
			}
		});
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (chkServico.isSelected()) {
					cboStatus.setModel(new DefaultComboBoxModel(
							new String[] { "", "Na bancada", "Aguardando retirada", "Retirado" }));
				}
			}
		});
		...
		lblNewLabel_4.setIcon(new ImageIcon(Servico.class.getResource("/img/smarthphone.png")));
